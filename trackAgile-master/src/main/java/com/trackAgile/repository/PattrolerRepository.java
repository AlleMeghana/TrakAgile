...
public interface PattrolerRepository extends JpaRepository<PatrollingTrack, Long> {
	...
	void savePatrollingTrack(
	        ...
	        @Param("endReadingPhotoUrl") String endReadingPhotoUrl,
	        @Param("startTime") LocalTime startTime,
	        @Param("endTime") LocalTime endTime,
	        @Param("endDate") LocalDate endDate,
	        @Param("travalledDistance") Long travalledDistance,
	        @Param("coordinate") String coordinate,
	        @Param("lastKnownLocation") String lastKnownLocation,
	        @Param("locationTrack") String locationTrack, // Assuming locationTrack is handled separately
	        @Param("lastNowLocation") String lastNowLocation,
	...
	//Optional<User> findByEmployeeIdAndDate(Long loggedInEmployeeId, LocalDate now);
	...
	Double findTotalDistanceByEmpIdAndDateRange(@Param("empId") Long empId, @Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
